...
currency_list = ["AUD", "BRL", "CAD", "CHF", "CLP", "CNY", "CZK", "DKK", "EUR", "GBP", "HKD", "HUF", "IDR", "ILS",
    ...
    try:
        ...
        for currency in currency_list:
            try:
                ...
                print(rdata.hset("prices", "coinmarketcap:nano-" + currency.lower(), price_currency),
...
def bitfinex():
    try:
        bitfinex = float(Bitfinex().get_current_price())
